...
public class TurkishTokenizer extends BabylGenericTokenizer
{
    public TurkishTokenizer(ParserErrorReportingBase p, TokenCharStream in, TokenStream ts)
    {
        super(p, 
                in, 
                ts, 
                new BabylTokenizer.DecimalNumberReader(','),
                TranslatedNameBindings.getKeywordMap("tr"));
    }
}
